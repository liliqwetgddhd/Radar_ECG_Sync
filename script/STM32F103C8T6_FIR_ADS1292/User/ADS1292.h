...
// 位操作
//-----------------------------------------------------------------
#define PWDN_L      GPIO_ResetBits(GPIOB, GPIO_Pin_10)
#define PWDN_H     	GPIO_SetBits(GPIOB, GPIO_Pin_10)
#define START_L     GPIO_ResetBits(GPIOB, GPIO_Pin_11)
#define START_H     GPIO_SetBits(GPIOB, GPIO_Pin_11)
