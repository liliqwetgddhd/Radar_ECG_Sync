ar1.FullReset()
ar1.SOPControl(2)
ar1.Connect(15,921600,1000) --first num is Application/User UART id

-- Author:
-- Woyun_
-- https://blog.csdn.net/Woyun_?type=blog
...
adc_data_path = "D:\\software\\temporary\\DatasetFile\\Action\\adc_data.bin"
...
if((partId == 1642) or (partId == 1843)) then
    if(ar1.ProfileConfig(0, 77, 10, 6, 60, 0, 0, 0, 0, 0, 0, 64.985, 1, 256, 5000, 0, 0, 30) == 0) then
...
-------------------------------------FrameConfig-------------------------------------
if (ar1.FrameConfig(0, 2, 4000, 2, 4, 0, 0, 2) == 0) then
